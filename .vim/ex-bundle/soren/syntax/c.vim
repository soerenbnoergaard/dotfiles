...
" Modified:     Søren Nørgaard <soerenbnoergaard@gmail.com>, Maj 2013
" Filenames:    *.c,*.h
...
" Soren: Doxygen in comments.
syn match         cDoxygen          contained "@\w\+"
syn match         cDoxygen          contained "@param\s\+\w\+"
syn match         cDoxygen          contained "@param\s*\[.\+\]\s\+\w\+"
syn cluster       cCommentGroup     add=cDoxygen
...
" Soren: Special comments
syn match         cSpecialCommentDelim     contained "/\*\*\|\*\*/"
if exists("c_no_comment_fold")
  syn region      cSpecialComment   keepend matchgroup=cSpecialCommentDelim start="/\*\*" end="\*/" contains=cCommentString,cCharacterNoError,@cCommentGroup,cCommentStartError,@Spell
else
  syn region      cSpecialComment   keepend matchgroup=cSpecialCommentDelim start="/\*\*" end="\*/" contains=cCommentString,cCharacterNoError,@cCommentGroup,cCommentStartError,@Spell fold
endif
...
if exists("c_cpp_comments") || (exists("c_C99") && !exists("c_C99_warn"))
  ...
  if exists("c_no_comment_fold")
    ...
    syn region    cSpecialComment   start="///" skip="\\$" end="$" contains=cComment2String,cCharacterNoError,@cCommentGroup,cPPLineJoin,cPPLineJoinError,@Spell
  else
    ...
    syn region    cSpecialComment   start="///" skip="\\$" end="$" contains=cComment2String,cCharacterNoError,@cCommentGroup,cPPLineJoin,cPPLineJoinError,@Spell fold
  endif
else
...
hi def link cSpecialCommentDelim   cSpecialComment
