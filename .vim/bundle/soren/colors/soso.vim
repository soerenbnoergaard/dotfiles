...
hi DiffText                   guibg=#bfdfff gui=NONE                  ctermbg=6     cterm=bold
...
hi StatusLine   guifg=bg      guibg=black   gui=NONE ctermfg=bg       ctermbg=black cterm=bold
...
hi Statement    guifg=black   guibg=bg      gui=NONE ctermfg=black                  cterm=NONE
...
if version >= 700
  ...
  hi TabLineSel                             gui=NONE                                                       cterm=bold
